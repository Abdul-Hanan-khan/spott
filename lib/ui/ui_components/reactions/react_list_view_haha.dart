...
class HahaListViewScreen extends StatefulWidget {
  final PostReactsModel reacts;
  const HahaListViewScreen({Key? key, required this.reacts}) : super(key: key);

  @override
  _HahaListViewScreenState createState() => _HahaListViewScreenState();
}

class _HahaListViewScreenState extends State<HahaListViewScreen> {
  @override
