...
class LoveListViewScreen extends StatefulWidget {
  final PostReactsModel reacts;
  const LoveListViewScreen({Key? key,required this.reacts}) : super(key: key);

  @override
  _LoveListViewScreenState createState() => _LoveListViewScreenState();
}

class _LoveListViewScreenState extends State<LoveListViewScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          if(widget
              .reacts.data![index].reactKey==1) {
            return InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=> ViewProfileScreen(widget.reacts.data![index].user)));
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: widget.reacts.data![index].user!.profilePicture
                            ...
                            image: NetworkImage(widget
                              ...
                              : null),
                      child: widget.reacts.data![index].user!.profilePicture == null
                          ? Text(
