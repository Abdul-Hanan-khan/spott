...
class SadListViewScreen extends StatefulWidget {
  final PostReactsModel reacts;
  const SadListViewScreen({Key? key,required this.reacts}) : super(key: key);

  @override
  _SadListViewScreenState createState() => _SadListViewScreenState();
}

class _SadListViewScreenState extends State<SadListViewScreen> {
  @override
