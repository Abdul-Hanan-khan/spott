...
class LikeListViewScreen extends StatefulWidget {
    final PostReactsModel reacts;
  const LikeListViewScreen({Key? key, required this.reacts}) : super(key: key);

  @override
  _LikeListViewScreenState createState() => _LikeListViewScreenState();
}

class _LikeListViewScreenState extends State<LikeListViewScreen> {
  @override
