...
class PlaceStoriesScreen extends StatefulWidget {
  const PlaceStoriesScreen(this.id, this.name,{Key? key}) : super(key: key);

  final String id;
  final String name;

  @override
  _PlaceStoriesScreenState createState() => _PlaceStoriesScreenState();
}
...
class _PlaceStoriesScreenState extends State<PlaceStoriesScreen> {
