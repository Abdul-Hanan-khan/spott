...
/// Widget to display animated gif or still images. Shows a loader while image
...
class StoryImage extends StatefulWidget {
  ...
  /// Use this shorthand to fetch images/gif from the provided [url]
  ...
  void initState() {
    ...
    if (widget.controller != null) {
      this._streamSubscription =
        ...
        // for the case of gif we need to pause/play
